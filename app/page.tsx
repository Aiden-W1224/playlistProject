...
export default function Home() {
  ...
  return (
  <body className="leading-normal tracking-normal text-indigo-400 m-6 bg-cover bg-fixed" style={backgroundImageStyle}>
    <div className="h-full">
      <div className="w-full container mx-auto">
        <div className="w-full flex items-center justify-between">
          <a className="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
            P2<span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">P</span>
          </a>
      ...
      <div className="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div className="mx-auto flex flex-col items-center text-center pb-24 lg:pb-0 fade-in">
          <p className="text-blue-400 font-bold pb-8 lg:pb-6">
            Connect with us on LinkedIn:
          </p>
          <div className="flex flex-row items-center justify-center">
            <div className="flex flex-col items-center pr-8">
              <a href='https://www.linkedin.com/in/aiden-wong-2083b1213/'>
                <p className="pb-2">Aiden:</p>
                <img src="linkedIn-image.svg" className="h-12 rounded-md transform hover:scale-125 duration-300 ease-in-out" alt="First LinkedIn Image" />
              </a>
            </div>
            <div className="flex flex-col items-center">
              <a href='https://www.linkedin.com/in/amka-tsendjargal/'>
                <p className="pb-2">Amka:</p>
                <img src="linkedIn-image.svg" className="h-12 rounded-md transform hover:scale-125 duration-300 ease-in-out" alt="Second LinkedIn Image" />
              </a>
            </div>
          </div>
        </div>
